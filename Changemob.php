...
<html>
   ...
   <div class="container">
       ...
       <div><font size="4" face="Baskerville Old Face">
           <form action="change_user_mob.php" method="post">
           <b><table align="center"><tr><td>Mobile No:</td><td align="right"><input type=text class="form-control" name="txt1" id="txt1"  autofocus required></td></tr>
