<html>
   ...
   <div class="container">
       ...
       <div><font size="4" face="Baskerville Old Face">
           <form action="change_user_add.php" method="post">
           <b><table align="center"><tr><td align="left">Address:</td><td align="right"><input type=text class="form-control" name="txt1" id="txt1"  autofocus required></td></tr>
               <tr><td colspan="2" align="right"><input type=submit value="Submit" name="btn-1" class="btn btn-outline-success"></td></tr>   
               </table></b></form></font></div>
       <div class="container-fluid" align="center">
           <br><br><br><br><b>&copy;All Right are reserved&nbsp;&nbsp;&nbsp;<font size="5" face="Baskerville Old Face">Rail Yatra.</font></b></div></div></body></html>